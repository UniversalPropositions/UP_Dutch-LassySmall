...
- `git clone https://github.com/UniversalPropositions/UP_Dutch-LassySmall.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Dutch-LassySmall>/ --input_up=<up_path_to_UP_Dutch-LassySmall>/ --output=<path_to_UD+UP_Dutch-LassySmall>/`
